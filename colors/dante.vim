...
hi Search	term=reverse ctermfg=black ctermbg=yellow guifg=peachpuff guibg=#404000
...
hi Folded	term=standout cterm=underline ctermfg=darkblue guifg=cyan4 guibg=gray10
hi FoldColumn	term=standout cterm=underline ctermfg=darkblue ctermbg=lightgray guifg=cyan4 guibg=gray10
...
hi Cursor	guibg=#006077
hi lCursor	guibg=#006077
"hi Cursor	guifg=bg guibg=fg
"hi lCursor	guifg=bg guibg=fg
hi StatusLine	term=reverse cterm=reverse gui=reverse guifg=gray40
hi StatusLineNC	term=reverse cterm=reverse gui=reverse guifg=gray20
hi VertSplit	term=reverse cterm=reverse gui=bold,reverse guifg=gray20
hi Title	term=bold ctermfg=magenta gui=bold guifg=aquamarine
hi Pmenu guibg=gray20
hi PmenuSel gui=bold guibg=gray40
hi CursorLine guibg=#001027
hi CursorColumn guibg=#001027
hi SignColumn guibg=gray10
hi TabLine guibg=gray20
hi TabLineFill guifg=gray10
hi TabLineSel guibg=black guifg=dodgerblue4
...
hi Todo		term=standout ctermfg=white ctermbg=darkyellow gui=none guifg=peachpuff guibg=#404000
